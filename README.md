...
- `questionText` - текст вопроса в формате markdown-строки (подробнее о формате markdown написано ниже). Лучше ограничиться одним параграфом. Здесь, и в других полях, можно использовать эмодзи😉
